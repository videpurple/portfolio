...
|🔖 Month 2 평균 유지율이 33.8%로, 업종 대부분의 8주 후 평균 유지율이 20% 미만[¹⁾](https://www.notion.so/E-commerce-a826303f73614db3b9f35b4733bc52c0?pvs=21)인 것에 반해 **높은 유지율**을 보이고 있습니다.<br>Month 2에서 **유지율이 가장 낮고**, 중간에 잠시 하락 혹은 유지하는 구간이 존재하지만 대체적으로 유지율이 증가하는 추세를 볼 수 있습니다.<br>→ Month2 유지율을 높일 수 있는 방안을 찾아야 합니다.|
|:-|
